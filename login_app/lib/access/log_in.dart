            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(94.5, 320.0, 39.0, 19.0),
                    size: Size(228.0, 419.0),
                    fixedWidth: true,
                    fixedHeight: true,
                    child: Text(
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(80.5, 370.0, 68.0, 19.0),
                    size: Size(228.0, 419.0),
                    pinBottom: true,
                    fixedWidth: true,
                    fixedHeight: true,
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            ...
                            const Color(0xff7ce0f8),
                            const Color(0xff6d72e8)
                          ],
                          stops: [0.0, 0.0, 1.0],
                        ),
                        border: Border.all(
